...
You have an algorithm example in the Wikipedia page about Binary Search Trees. The method should accept a value of the 
data that the node to be deleted contains (this is for making the method easier to the end user of the class). 
The method should find the node to be deleted based on the given value (it's allow to use the _find helper method of the 
class)

To be fair, the algorithm presented in the Wikipedia page uses its own small "shift_nodes" helper function. You can use 
that as well."""
